...
import { Play, Calendar, Clock, Loader2, ArrowRight } from 'lucide-react'
        ...
        <div className="max-w-5xl mx-auto space-y-6">
          {episodes.map((episode, index) => (
            <Link
              ...
              key={episode.id}
              className="glass-card p-6 hover:border-spotlight-500/50 transition-all group block"
            >
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                {/* Episode Image */}
                <div className="w-full sm:w-48 md:w-64 aspect-square rounded-lg flex-shrink-0 cursor-pointer relative overflow-hidden group/play">
                  {episode.imageUrl ? (
                    <Image
                ...
                <div className="flex-1 min-w-0 flex flex-col">
                  ...
                  <h3 className="font-display text-lg sm:text-xl font-bold text-white mb-2 group-hover:text-spotlight-400 transition-colors">
                    {episode.title}
                  </h3>
                  ...
                  <p className="text-sm sm:text-base text-gray-400 mb-4 sm:mb-6 line-clamp-3 sm:line-clamp-4">
                    {stripHtml(episode.description)}
                  </p>

                  <div className="mt-auto">
                    <div className="inline-flex items-center gap-2 text-spotlight-400 font-semibold group-hover:gap-3 transition-all text-sm sm:text-base">
